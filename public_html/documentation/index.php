...
<body>
	...
	<p>ABQ Open Trails will be a website for hikers and mountain bikers, used primarily as a way to find trail maps
		...
		group, share information with friends, and build a trail map for future use.  There will also be a section
		containing Tips, Tricks,and General Information for users wishing to increase their hiking or mountain
		biking proficiency.
	</p>
</body>