...
class SegmentTest extends TrailQuailTest{
	...
	**/
	...
	$this->assertSame($pdoSegment->getSegmentStart()->getX->getY,"{$this->VALID_SEGMENTSTART}");
	$this->assertSame($pdoSegment->getSegmentStop()->getX->getY,"{$this->VALID_SEGMENTSTOP}");
