...
<nav class="navbar navbar-inverse">
	...
	<div class="collapse navbar-collapse" id="main-menu">
		<ul class="nav navbar-nav navbar-right">
			<li>
				<a class="btn btn-default btn-md" href="#/trail-search">Find Trails</a>
			</li>
			<li>
				<a class="btn btn-default btn-md" href="#/trail-site-info">About this site</a></li>
			...
			<?php if(!empty($_SESSION["user"])) {
				...
				if($accountType === "S") { ?>
					<li>
						<a class="btn btn-default btn-md" href="#/trail-update-approval">Approve Updates</a>
					</li>
				...
				<?php } elseif($accountType === "X") {
					header("Location:" . "#/trail-suspended-account");
				}
			} ?>
